...
[article](technical_blog.md). Each other document has a narrower operational
or evidentiary role.
...
Experiment reports are evidence, not alternate narrative drafts.

## Experiment records

- [Guarded agent-step report](agent_step_router_v2_final_report.md): the main
  60-task agent result.
- [First agent-step report](agent_step_router_v1_final_report.md): the
  first live activation study.
- [Isolated-scout report](isolated_stage_v1_final_report.md): task-level
  complementarity and transfer study.
- [Kimi qualification report](kimi128_strong_qualification_report.md):
  explicit submissions and the terminal-workspace diagnostic.
